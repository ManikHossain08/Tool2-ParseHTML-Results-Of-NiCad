...
public class JsonObjectGetter {
	...
	public JSONObject getJSONFromUrl(String url1) {
		...
		String inline = "";
		try {
			URL url = new URL("https://api.stackexchange.com/2.2/questions/1574089?order=desc&sort=activity&site=stackoverflow");
			...
			if (responsecode != 200)
				...
				GZIPInputStream gzis = new GZIPInputStream(new FileInputStream(inline));
